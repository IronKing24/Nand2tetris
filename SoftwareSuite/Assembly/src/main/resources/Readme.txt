...
It is not recommended to put any of your own files under this
...
Use this command to run the programs
--------------------------------------------------------------
java -classpath "bin/classes:bin/lib/*" {main class name}


Software Requirements (brief):
--------------------------------------------------------------
The Software Suite requires JRE1.8 or JDK1.8 (or later
versions).
