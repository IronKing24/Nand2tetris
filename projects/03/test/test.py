"""This module is for testing the third set of the Hack machine hardware component"""
...
class TestHardwareComponents(unittest.TestCase):
    """Class for testing the third set of the Hack machine hardware component"""
    @classmethod
    def setUpClass(cls):
        global test_path
        global class_path
    ...
    def test_hardware_component(self):
        """This method tests Bit, Register, RAM8, RAM64, RAM512, RAM4K, RAM16K, PC"""
